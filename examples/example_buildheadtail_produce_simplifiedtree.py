...
xdifflim=2.0
vdifflim=1.0
vpt.FixTruncationBranchSwapsInTreeDescendant(numsnaps, rawtreedata, halodata, numhalos, npartlim, meritlim, xdifflim, vdifflim, NSNAPSEARCH, TEMPORALHALOIDVAL)
print("Finished fixing branch swapping events", time.clock()-start)

#write the tree and quit
DescriptionInfo={
        'Title':'Walkable Tree', 'TreeBuilder':'TreeFrog', 'TreeBuilder_version':1.2, 'Temporal_linking_length':NSNAPSEARCH, 'Temporal_halo_id_value':TEMPORALHALOIDVAL}
vpt.WriteWalkableHDFTree(outputfname,numsnaps,rawtreedata,numhalos,halodata,atime,DescriptionInfo)
quit()
